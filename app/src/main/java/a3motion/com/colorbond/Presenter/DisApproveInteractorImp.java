...
public class DisApproveInteractorImp implements DisApproveInteractor {
    String response_message;

    @Override
    public void doDisAPprove(String token, String id_notif, final OnSuccessDisApproveListener listener) {
        ...
        final Call<ResponseBody> call = service.Dissapproce(token, id_notif);
