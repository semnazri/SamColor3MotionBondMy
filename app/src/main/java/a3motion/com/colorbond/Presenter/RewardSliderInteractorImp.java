...
public class RewardSliderInteractorImp implements RewardSliderInteractor {
    String response_message;


    @Override
    public void getSlider(String token, String type, final OnSuccessgetEventListener listener) {
        ...
        final Call<ResponseBody> call = service.getSlider(token,type);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Gson gson = new Gson();
                    try {
                        RewardSliderResponse rewardSliderResponse = gson.fromJson(response.body().string(), RewardSliderResponse.class);
                        listener.onSuccess(response_message, rewardSliderResponse);
