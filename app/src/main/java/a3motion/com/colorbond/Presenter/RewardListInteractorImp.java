...
public class RewardListInteractorImp implements RewardListInteractor {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Gson gson = new Gson();
                    try {
                        RewardListResponse rewardListResponse = gson.fromJson(response.body().string(), RewardListResponse.class);
                        listener.onSuccess(response_message, rewardListResponse);
