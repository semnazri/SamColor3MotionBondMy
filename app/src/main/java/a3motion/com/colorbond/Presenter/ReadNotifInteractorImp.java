...
public class ReadNotifInteractorImp implements ReadNotifInteractor {
    String response_message;

    @Override
    public void doRead(String token, String id_notif, final OnSuccessReadListener listener) {
        ...
        final Call<ResponseBody> call = service.doRead(token,id_notif);
