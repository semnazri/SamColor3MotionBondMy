...
public class AchievementInteractorImp implements AchievementInteractor {
    String response_message;

    @Override
    public void getAchievement(String token, final OnSuccessgetAchievementListener listener) {
        ...
        final Call<ResponseBody> call = service.getAchievement(token);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Gson gson = new Gson();
                    try {
                        TeamAchivementResponse teamAchivementResponse = gson.fromJson(response.body().string(), TeamAchivementResponse.class);
                        listener.onSuccess(response_message, teamAchivementResponse);
