...
public class RewardReedemInteractorImp implements RewardReedemInteractor {
    ...
    @Override
    public void doRequest(String token, String id_master_reward, String status, final OnSuccessOrderRewardListener listener) {
        ...
        final Call<ResponseBody> call = service.doReedem(token, id_master_reward, status);
