...
public class ColorBondTypeAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Material> mValues;

    public ColorBondTypeAdapter(Context context, List<Material> items) {
        mContext = context;
        mValues = items;
