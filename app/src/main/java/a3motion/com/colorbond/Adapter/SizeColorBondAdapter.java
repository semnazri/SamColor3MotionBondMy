...
public class SizeColorBondAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Size_material> mValues;

    public SizeColorBondAdapter(Context context, List<Size_material> items) {
        mContext = context;
        mValues = items;
