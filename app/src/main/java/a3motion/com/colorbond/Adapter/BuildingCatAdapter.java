...
public class BuildingCatAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Building_cats> mValues;

    public BuildingCatAdapter(Context context, List<Building_cats> items) {
        mContext = context;
        mValues = items;
