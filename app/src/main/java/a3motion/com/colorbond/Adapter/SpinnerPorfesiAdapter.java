...
public class SpinnerPorfesiAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Profesi> mValues;

    public SpinnerPorfesiAdapter(Context context, List<Profesi> items) {
        mContext = context;
        mValues = items;
