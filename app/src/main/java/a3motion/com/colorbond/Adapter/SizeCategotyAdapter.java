...
public class SizeCategotyAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<Size_category> mValues;

    public SizeCategotyAdapter(Context context, List<Size_category> items) {
        mContext = context;
        mValues = items;
